 ...
 *       Entry  :   Always
 *       LED    :   PA2, Active High
 *       OSCCAL :   Save OSCAL and load for user program (12 MHz)
...
#define USB_INTR_PENDING        GIFR
#define USB_INTR_PENDING_BIT    INT0
 ...
 *                      Adds 22 bytes.
 * 
 *  ENTRY_EXT_OR_WD     Combination of ENTRY_EXT_RESET or'd with ENTRY_WATCHDOG - either w
 *                      will trigger.
 *                      Adds 22 bytes.
 *
...
#define ENTRYMODE ENTRY_EXT_OR_WD
...
#elif ENTRYMODE==ENTRY_EXT_OR_WD
  #define bootLoaderInit()
  #define bootLoaderExit()
  #define bootLoaderStartCondition() (MCUSR & (_BV(EXTRF) | _BV(WDRF)))
#else
...
#define AUTO_EXIT_NO_USB_MS    100
...
#define LED_PIN     PA3
#else
#error "BOARD_REV must be one of REV_A, REV_B"
#endif
